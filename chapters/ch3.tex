...
Tale requisito deve essere mantenuto anche con un carico simultaneo fino a 20.000 utenti connessi (o carico target equivalente espresso in RPS)\footnote{Per “20.000 utenti simultanei” si intende il picco di concorrenza durante consultazioni di grande rilevanza; i target p95 si applicano alle operazioni chiave (login, consultazione lista proposte, espressione del voto).}.
...
\begin{itemize}
  \item \textbf{DCAT-AP\_IT} - Profilo italiano di interoperabilità per cataloghi Open Data.
