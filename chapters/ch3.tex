...
Il sistema deve garantire un'affidabilità elevata, con una disponibilità minima del 99.72{\%}, corrispondente ad un downtime massimo di 24 ore all'anno. Il software deve essere progettato per minimizzare i tempi di inattività pianificati e non pianificati, garantendo un accesso continuo ai servizi, in osservanza del \ref{ref:performance}.
...
\subsection{Etica} \label{ref:etica}
Il software è progettato per garantire la massima neutralità intellettuale della parti coinvolte, dunque l'assenza di bias politici, ideologici o sociali. Ogni azione eseguita da cittadini o dagli amministratori comunali si deve concepire come miglioramento alla vita pubblica in modo imparziale. Si prevede che il software fornisca strumenti tecnici e criteri oggettivi per la valutazione dei casi proposti, con l'obiettivo di sopprimere sbilanciamenti di carattere politico o socialmente divisivi. 

\subsection{Lingua}
Il sistema deve offrire agli utenti la possibilità di cambiare la lingua dell’interfaccia tra una delle seguenti opzioni: Italiano, Inglese, Tedesco, Arabo e Rumeno. La selezione della lingua deve essere facilmente accessibile e applicabile in qualsiasi momento; garantendo inoltre coerenza e precisione nelle funzionalità indipendentemente dalla lingua.
...
Il sistema deve garantire tempi di risposta brevi, in tal modo che qualsiasi operazione, come il login, la visualizzazione delle proposte o il voto, vengano completate entro un massimo di 1 secondo per il 95{\%} delle richieste. Tale requisito deve essere mantenuto anche in presenza di notevoli flussi di connessioni, con un carico simultaneo sostenibile fino ai 20.000 utenti connessi al sistema.
...
Dal punto di vista del software, si assicura elevata riutilizzabilità e chiarezza in tutte le parti che lo compongono; si garantisce dunque che in caso di revisione futura del sofware, la struttura di partenza agevoli il più possibile i tempi di risoluzione dei problemi posti.
