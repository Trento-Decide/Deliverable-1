...
La piattaforma rende il processo decisionale più inclusivo, trasparente e reattivo, offrendo uno spazio digitale in cui proporre, discutere e votare iniziative di interesse pubblico.
...
\begin{description}
  ...
  Persona fisica di età pari o superiore a 16 anni \footnote{Questa soglia è stata scelta per promuovere la partecipazione giovanile, in linea con l'età minima prevista per il diritto di voto in alcune consultazioni locali e in analogia con il limite di età per il trattamento dei dati personali senza consenso dei genitori secondo il GDPR (art. 8).}, residente nel Comune di Trento o ivi domiciliata per motivi di studio o lavoro.  
  ...
  Iniziativa promossa da un gruppo di cittadini o da un’associazione riconosciuta.  
  ...
  L’anonimato è garantito mediante l’uso di token di voto temporanei disaccoppiati dall’identità dell’utente, che consentono la revoca entro la finestra temporale di voto senza comprometterne la segretezza.
...
\begin{itemize}
  ...
  \item \textbf{Chiarezza sul percorso}: ogni iniziativa riporta in modo trasparente il proprio stato
