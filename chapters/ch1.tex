...
\begin{figure}[h!]
	...
	\begin{minipage}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/D0/1.png}
		\caption{Problema}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/D0/2.png}
		\caption{Soluzione}
	\end{minipage}
	...
	\begin{minipage}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/D0/3.png}
		\caption{Vantaggi}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/D0/4.png}
		\caption{Dati a supporto}
	\end{minipage}
	 
	\label{fig:grid-mockups}
\end{figure}