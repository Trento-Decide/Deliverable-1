...
Nel caso di iniziative appartenenti a particolari categorie "notevoli" \defref{def:categorianotevole}, il sistema fornisce in fase preliminare analisi tecniche automatiche utili a supportare e velocizzare l’esame.
...
\item[Definizione \refstepcounter{definition}\thedefinition\label{def:categorianotevole} – Categoria notevole:]  
Sottoinsieme delle categorie per cui è prevista, oltre alla valutazione amministrativa ordinaria, un’analisi tecnica preliminare supportata dal sistema (ad es. stima di impatti economici, ambientali o infrastrutturali).  
L’elenco delle categorie notevoli è definito dall’amministrazione e può essere aggiornato tramite configurazione.
...
\textbf{Cittadino}:
Persona fisica di età pari o superiore a 16 anni, residente nel Comune di Trento o ivi  
...
Proposta presentata da un’associazione o comitato riconosciuto, distinta dalle proposte individuali in quanto esprime una posizione formalmente attribuibile a un soggetto collettivo e può avere un peso specifico diverso nei processi di valutazione e decisione rispetto alle proposte dei singoli cittadini.
...
\begin{itemize}
  ...
  (\textit{bozza}, \textit{in valutazione}, \textit{accettata}, \textit{rifiutata}), garantendo tracciabilità e riducendo l’asimmetria informativa.
...
\begin{itemize}
  ...
  La formula di ranking richiede un monitoraggio continuo e revisioni periodiche, come previsto dal Requisito Non Funzionale sulla neutralità algoritmica (\ref{rnf:etica}).
