...
\textbf{Riassunto:} Questo use case descrive come un cittadino crea una nuova proposta.
...
\begin{description}
  \item[Riassunto:] Questo use case descrive come un cittadino modifica una proposta esistente, sia come autore della proposta, sia proponendo una modifica a una proposta creata da altri utenti.
...
\begin{center}
  \includegraphics[scale=0.8]{img/usecase/Cittadino 2.png}
\end{center}
...
\textbf{Postcondizioni:}
La proposta risulta pubblicata e marcata come \textit{proposta collettiva}.

\textbf{Descrizione:}
\begin{enumerate}
	\item L’associazione accede alla sezione di creazione proposta.
	\item L’associazione seleziona l’opzione \textit{Proposta collettiva}.
	...
	\item Il sistema registra la proposta e la etichetta come \textit{proposta collettiva}, mostrando il nome dell’associazione. \textbf{[eccezione 1]}
\end{enumerate}
...
\begin{itemize}
	...
	\item La proposta è nello stato \textit{pubblicata}.
...
\begin{enumerate}
	...
	\item L’associazione seleziona l’opzione \textit{Esprimi endorsement}. \textbf{[eccezione 1]}
...
\begin{enumerate}
	...
	\item L’associazione seleziona l’opzione \textit{Rimuovi endorsement}.
	\item L’associazione conferma l’azione.
