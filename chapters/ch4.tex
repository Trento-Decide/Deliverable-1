...
\subsection{Modificare proposta~\ref{rf:modificaproposta}}
\begin{description}
...
\begin{enumerate}
  ...
  \item Il cittadino seleziona il comando \emph{``Segnala contenuto''} associato al contenuto.
  ...
  \item \emph{Facoltativamente}, il cittadino inserisce una descrizione aggiuntiva nel campo di testo.
