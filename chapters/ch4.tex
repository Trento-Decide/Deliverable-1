...
% \includegraphics[width=0.33 \textwidth]{img/usecase/1.png}

% ====================================================

\subsubsection*{Use Case \ref{sec:login}: Login}

\textbf{Attore primario:} Utente anonimo
...
\subsubsection*{Use Case \ref{sec:registrazione}: Registrare un cittadino}
