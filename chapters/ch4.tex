...
\begin{enumerate}
	...
	\item Pubblicare un report di valutazione su una proposta (\ref{rf:pubblicaportvalutazione})
...
\subsection{Pubblicazione proposta \ref{rf:pubblicazioneproposta}}

\subsection{Eliminazione proposta \ref{rf:scartareproposta}}
...
\begin{enumerate}
	\item Moderazione tramite coda di revisione (\ref{rf:modcoda})
