...
\subsection{Visualizzazione dashboard amministrativa} \label{sec:vederedashboard}
...
\begin{itemize}
	...
	\item \textbf{Dati generali del sistema}: numero di utenti attivi, proposte per categoria, distribuzione territoriale dei voti, tassi di approvazione.
\end{itemize}
