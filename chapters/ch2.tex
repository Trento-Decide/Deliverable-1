...
\subsection{Visualizzazione proposte} \label{sec:visualizzazioneproposte}
...
\subsection{Votazione delle proposte}  \label{sec:voto}
...
\subsection{Consultazioni e sondaggi}  \label{sec:sondaggi}
