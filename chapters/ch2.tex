...
Il sistema deve consentire alle associazioni di esprimere un singolo \textit{endorsement} digitale (def.~\ref{def:endorsement}) per ciascuna proposta pubblicata.
...
Il sistema deve consentire alle associazioni che hanno espresso un \textit{endorsement} di rimuoverlo.
...
Il sistema deve consentire all’amministratore di redigere, aggiornare e pubblicare il report di valutazione associato a una proposta, includendo testo descrittivo e indicatori quantitativi/qualitativi.