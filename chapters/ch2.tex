...
Il sistema deve mostrare all’utente i dati attualmente associati al profilo.
...
Il sistema deve consentire ai cittadini di creare una nuova proposta compilando un modulo che include i seguenti campi obbligatori:
