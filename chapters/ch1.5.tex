...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Cricitià:} Mantenere alti livelli di trasparenza (es. fornire feedback motivati a ogni proposta) rappresenta un costo significativo in termini di tempo e risorse per l'amministrazione.
    \end{itemize}
